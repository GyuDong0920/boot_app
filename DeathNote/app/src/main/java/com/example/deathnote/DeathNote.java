...
//            passwordPreferences = getSharedPreferences("password", Context.MODE_PRIVATE);
            ...
            if (passwordPreferences.getString(KEY_PWD, "000").equals(passwordFromUser)) {
                ...
                Intent intent = new Intent(this, MainActivity.class); // 화면전환 변경할 것!!!
